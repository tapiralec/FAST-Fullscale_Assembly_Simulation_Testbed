...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_XRTLogging p_XRTLogging;
        ...
        public static SteamVR_Input_ActionSet_XRTLogging XRTLogging
        {
            get
            {
                return SteamVR_Actions.p_XRTLogging.GetCopy<SteamVR_Input_ActionSet_XRTLogging>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_XRTLogging = ((SteamVR_Input_ActionSet_XRTLogging)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_XRTLogging>("/actions/XRTLogging")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.XRTLogging};
        }
    }
}
